...
BUILD_FLAGS ?= -ldflags '-s -w -X "github.com/andybar2/graphjin/serv.version=${BUILD_VERSION}" -X "github.com/andybar2/graphjin/serv.commit=${BUILD}" -X "github.com/andybar2/graphjin/serv.date=${BUILD_DATE}"'
